...
export * from "./components/autor-list/autor-list.component"
export * from "./components/styles-autors-books/styles-autors-books.component"
...
export * from "./components/stylesList/stylesList.component"
