...
import { Autor, Book, User,IUser, styleBook } from '../../index'
@Injectable({
  providedIn: 'root'
})
export class DataService implements InMemoryDbService {
  ...
  createDb(){
    let autors: Autor[] =
      [
        new Autor('Автор 1', 'Имя 1', new Date(18, 1, 1999), 'rrrrr sdghwrth ghreth gerthwrthwb gregh4rt bgrhwrthwb rewthwetgb fgwegqg saegweg',
          [0,1,2],0),

        new Autor('Автор 2', 'Имя 2', new Date(2, 11, 1900), 'rrrrr sdghwrth ghreth gerthwrthwb gregh4rt bgrhwrthwb rewthwetgb fgwegqg saegweg', 
         [3,4,5], 1,'Отчество 2'),

        new Autor('Автор 3', 'Имя 3', new Date(2, 11, 1900), 'rrrrr sdghwrth ghreth gerthwrthwb gregh4rt bgrhwrthwb rewthwetgb fgwegqg saegweg',[6,7,8],
          2,'Отчество 3'),

        new Autor('Автор 4', 'Имя 4', new Date(29, 10, 1899), 'rrrrr sdghwrth ghreth gerthwrthwb gregh4rt bgrhwrthwb rewthwetgb fgwegqg saegweg', [9,10,11],
          3,'Отчество 4'),

        new Autor('Автор 5', 'Имя 5', new Date(2, 11, 1900), 'rrrrr sdghwrth ghreth gerthwrthwb gregh4rt bgrhwrthwb rewthwetgb fgwegqg saegweg', [12, 13, 14],
          4),
      ];
    ...
    let users: IUser[] = [
      ...
      new User('user2', 'qwerty', 'email@email.com', '3', ['+375293334455'], ['4,', '12', '13', '14'], ['4,', '12', '13', '14']),
    ...
    let books: Book[] = [
      new Book('Автор 1 книга 1', 30, styleBook.Fantastic, 'gggg еркцкроц пароыкрц4 керцкерц ыпртыеуруйр птрыртыкотцк', '1.jpg', '0', new Date( 1983,0,19), '0',1, ['0']),
      new Book('Автор 1 книга 2', 30, styleBook.Fantastic, 'gggg еркцкроц пароыкрц4 керцкерц ыпртыеуруйр птрыртыкотцк', '2.jpg', '0', new Date(18, 1, 2000), '1', 2, ['4','5']),
