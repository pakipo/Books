...
export class DataService implements InMemoryDbService {
  ...
  createDb(){
    ...
    let books: Book[] = [
      ...
      new Book('Автор 1 книга 3', 30, styleBook.Adventures, 'gggg еркцкроц пароыкрц4 керцкерц ыпртыеуруйр птрыртыкотцк', '3.jpg', 0, new Date(1988, 3, 1), 2, 1, ['1'], ''),
      new Book('Автор 2 книга 1', 30, styleBook.Detective, 'gggg еркцкроц пароыкрц4 керцкерц ыпртыеуруйр птрыртыкотцк', '4.jpg', 1, new Date(1999, 1, 18), 3, 1, ['2'], ''),
      new Book('Автор 2 книга 2', 30, styleBook.History, 'gggg еркцкроц пароыкрц4 керцкерц ыпртыеуруйр птрыртыкотцк', '5.jpg', 1, new Date(1966, 1, 18), 4, 2, ['1', '3'], ''),
      new Book('Автор 2 книга 3', 30, styleBook.Detective, 'gggg еркцкроц пароыкрц4 керцкерц ыпртыеуруйр птрыртыкотцк', '6.jpg', 1, new Date(1978, 1, 18), 5, 1, ['1'], ''),
      new Book('Автор 3 книга 1', 30, styleBook.Fantastic, 'gggg еркцкроц пароыкрц4 керцкерц ыпртыеуруйр птрыртыкотцк', '7.jpg', 2, new Date(1983, 1, 18), 6, 1, ['4'], ''),
      new Book('Автор 3 книга 2', 30, styleBook.Fantastic, 'gggg еркцкроц пароыкрц4 керцкерц ыпртыеуруйр птрыртыкотцк', '8.jpg', 2, new Date(1889, 118), 7, 1, ['1'], ''),
      new Book('Автор 3 книга 3', 30, styleBook.Fantasy, 'gggg еркцкроц пароыкрц4 керцкерц ыпртыеуруйр птрыртыкотцк', '9.jpg', 2, new Date(1890, 5, 15), 8, 1, ['1'], ''),
      new Book('Автор 4 книга 1', 30, styleBook.Fantastic, 'gggg еркцкроц пароыкрц4 керцкерц ыпртыеуруйр птрыртыкотцк', '10.jpg', 3, new Date(1981, 3, 18), 9, 2, ['1', '4'], ''),
      new Book('Автор 4 книга 2', 30, styleBook.Detective, 'gggg еркцкроц пароыкрц4 керцкерц ыпртыеуруйр птрыртыкотцк', '11.jpg', 3, new Date(1982, 6, 18), 10, 1, ['2'], ''),
      new Book('Автор 4 книга 3', 30, styleBook.Fantastic, 'gggg еркцкроц пароыкрц4 керцкерц ыпртыеуруйр птрыртыкотцк', '12.jpg', 3, new Date(1984, 8, 18), 11, 1, ['2'], ''),
      new Book('Автор 5 книга 1', 30, styleBook.History, 'gggg еркцкроц пароыкрц4 керцкерц ыпртыеуруйр птрыртыкотцк', '13.jpg', 4, new Date(2011, 4, 23), 12, 2, ['3', '5'], ''),
      new Book('Автор 5 книга 2', 30, styleBook.Fantastic, 'gggg еркцкроц пароыкрц4 керцкерц ыпртыеуруйр птрыртыкотцк', '14.jpg', 4, new Date(2012, 8, 23), 13, 1, ['3'], ''),
      new Book('Автор 5 книга 3', 30, styleBook.Fantasy, 'gggg еркцкроц пароыкрц4 керцкерц ыпртыеуруйр птрыртыкотцк', '15.jpg', 4, new Date(2020, 11, 28), 14, 2, ['3', '5'], ''),
